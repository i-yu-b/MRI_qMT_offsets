function Mzf = SPGR_ramani(parameters, Wr, offsets, omega1)
%{
...
input:
    ...
    omega1 - averaged omega1 value, [rad/s]
...
numerator = R1m * coeff1 + Wr + R1m + kmf; 
denominator = coeff1 * (R1m + Wr) + (1 + Wf).*(R1m + Wr+ kmf);
